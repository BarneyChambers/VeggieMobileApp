...
{
    public class Brazio : NetworkSetBase
    {
        public static Brazio Instance { get; } = new Brazio();

        public override string CryptoCode => "BRAZ";
    ...
    //Tuple.Create(new byte[]{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xff,0xff,0x01,0xca,0x80,0xda}, 10333),
        Tuple.Create(new byte[]{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xff,0xff, 0x80, 0x0c, 0x12, 0x23}, 22780), //0x080c1223
        Tuple.Create(new byte[]{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xff,0xff,0x80,0x0c,0x12,0xaf}, 22780) //0x080c12af
    };
...
#pragma warning disable CS0618 // Type or member is obsolete
        public class BrazioConsensusFactory : ConsensusFactory
        {
            private BrazioConsensusFactory()
            {
            }

            public static BrazioConsensusFactory Instance { get; } = new BrazioConsensusFactory();

            public override BlockHeader CreateBlockHeader()
            {
                return new BrazioBlockHeader();
            }
            public override Block CreateBlock()
            {
                return new BrazioBlock(new BrazioBlockHeader());
            }
        }

        public class BrazioBlockHeader : BlockHeader
        {
        ...
        public class BrazioBlock : Block
        {
            public BrazioBlock(BrazioBlockHeader header) : base(header)
            {

            }
            public override ConsensusFactory GetConsensusFactory()
            {
                return BrazioConsensusFactory.Instance;
            }
        }

        public class BrazioMainnetAddressStringParser : NetworkStringParser
        {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        protected override NetworkBuilder CreateMainnet()
        {
            ...
            builder.SetConsensus(new Consensus()
            {
                ...
                PowTargetTimespan = TimeSpan.FromSeconds(60 * 5),
                ...
                ConsensusFactory = BrazioConsensusFactory.Instance
            })
            ...
            .SetNetworkStringParser(new BrazioMainnetAddressStringParser())
            .SetBech32(Bech32Type.WITNESS_PUBKEY_ADDRESS, Encoders.Bech32("braz"))
            .SetBech32(Bech32Type.WITNESS_SCRIPT_ADDRESS, Encoders.Bech32("braz"))
            .SetMagic(0xdbb6c0fb) //revisit
            .SetPort(22780)
            .SetRPCPort(22780)
            .SetName("braz-main")
            .AddAlias("braz-mainnet")
            .AddAlias("Brazio-mainnet")
            .AddAlias("Brazio-main")
            .AddDNSSeeds(new[]
            {
                new DNSSeedData("8.12.18.35", "8.12.18.175")
        ...
        protected override NetworkBuilder CreateTestnet()
        {
            ...
            .SetRPCPort(19332)
            .SetName("braz-test")
            .AddAlias("braz-testnet")
            .AddAlias("brazio-test")
            .AddAlias("brazio-testnet")
            .AddDNSSeeds(new[]
            {
        ...
        protected override NetworkBuilder CreateRegtest()
        {
            ...
            .SetRPCPort(19332)
            .SetName("braz-reg")
            .AddAlias("braz-regtest")
            .AddAlias("brazio-reg")
            .AddAlias("brazio-regtest")
